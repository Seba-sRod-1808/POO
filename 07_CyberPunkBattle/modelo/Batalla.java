...
public class Batalla {
    ...
    private LinkedList<String> registroAcciones; // guarda las ultimas 3 acciones
    ...
    // Registrar acción y mantener solo las ultimas 3
    public void registrarAccion(String accion) {
        registroAcciones.addFirst(accion);
        if (registroAcciones.size() > 3) { // mantener solo las ultimas 3
